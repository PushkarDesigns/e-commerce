...
const ProductCard = ({ product }) => {
    ...
    return (
        <>
            {product && (
                <div
                    className="bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-200 
                ...
                >
                    ...
                    <div className="p-4 space-y-2">
                        ...
                        <p className="text-gray-800 font-semibold text-lg line-clamp-1">
                            {product.name}
                        </p>
...
//         <>
//             {product && (
//                 <div className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full" onClick={() => { navigate(`/product/${product.category.toLowerCase()}/${product._id}`) }}>
